...
function TypicalDota:OrderFilter(event)
	--PrintTable(event)
...
function TypicalDota:DamageFilter(keys)
	--DeepPrintTable(keys)
...
function TypicalDota:ModifierFilter(keys)
	--PrintTable(keys)
...
function TypicalDota:ExperienceFilter(keys)
	--PrintTable(keys)
...
function TypicalDota:ProjectileFilter(keys)
	--PrintTable(keys)
...
function TypicalDota:BountyRuneFilter(keys)
	--PrintTable(keys)
...
function TypicalDota:RuneSpawnFilter(keys)
	--print("rune spawned")
	--PrintTable(keys)
	--print("----------------------")
...
function TypicalDota:HealingFilter(keys)
	--PrintTable(keys)
...
function TypicalDota:GoldFilter(keys)
	--PrintTable(keys)
...
function TypicalDota:InventoryFilter(keys)
	--PrintTable(keys)
