...
if TypicalDota == nil then
	_G.TypicalDota = class({})
else
	DebugPrint("[BAREBONES] TypicalDota class name is already in use, change the name if this is the first time you launch the game!")
	DebugPrint("[BAREBONES] If this is not your first time, you probably used script_reload in console.")
end

require('util')
require ("components/creator")
require ("components/born_abilities_modifiers")
require ("components/chat_command")
...
--[[
  ...
  See GameMode:PostLoadPrecache() in gamemode.lua for more information
	...
	--PrecacheItemByNameSync("custom_item_fervor_yasha", context)
...
function Activate()
	...
	print("TypicalDota activated.")
	TypicalDota:InitGameMode()
	print("Activate modules")
	if CreatorClass ~= nill then CreatorClass:InitModule() end
	if TypicalDota.ChatCommand ~= nill then TypicalDota.ChatCommand:InitModule() end
end
